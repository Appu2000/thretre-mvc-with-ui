...
<div class="window">
  ...
  <div class="box footer">
    <ul>
      <li><a href=""><span class="ion-ios-camera-outline"></span>${id}</a></li>
      <li><a href="cur"><span class="ion-ios-heart-outline"></span>${cur}</a></li>
      <li><a href=""><span class="ion-ios-person-outline"></span>${rate}</a></li>
    </ul>
